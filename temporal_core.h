/*
  ...
  generated by cbindgen and is intentionally kept out of every translation unit
  that pulls in Zend. The glue layer talks to the core only through this header,
  passing opaque pointers and plain C types. This split also keeps the
  Tokio-thread callback path free of Zend/TSRM, by design.
